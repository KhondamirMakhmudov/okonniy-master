              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 md:p-16 border border-gray-200">
                ...
                <div className="space-y-6 text-gray-700">
                  <p className="text-lg md:text-xl leading-relaxed">
                    ...
                    Imzo и Engelberg, после чего было принято решение
                    организовать собственное производство.
                  </p>
                  <p className="text-lg md:text-xl leading-relaxed">
                    Самое главное в компании — коллектив! Нашими сотрудниками
                    становятся люди, готовые помогать, обучаться и обучать
                    других, те, кто оставляет не только положительные эмоции, но
                    и квалифицированную, качественную работу.
                  </p>
                  <p className="text-lg md:text-xl leading-relaxed">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-6 text-lg md:text-xl text-gray-700 leading-relaxed">
                <p>
                  ...
                  испытывали дискомфорта при работе с нашими специалистами.
                  Именно поэтому нами создана специальная служба по контролю
                  нашего сервиса. Она отслеживает качество выполненной работы,
                ...
                <p>
                  ...
                  результат ответственной работы наших специалистов. Вся
                  продукция подвергается тщательной проверке, от поступающих
                  заготовок до готового продукта. Наши эксперты пристально
                  следят за всеми процессами.
                </p>
              </div>
            </div>
          </section>
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6 text-lg md:text-xl text-gray-300">
                    <p className="leading-relaxed">
                      Чтобы обеспечить высочайший уровень своей работы и
                      выполнить поставленную задачу на отлично, специалисты
                      компании Оконный мастер регулярно посещают тренинги,
                      проходят обучение и регулярно подтверждают свою
                      квалификацию различными сертификатами.
                    </p>
                    <p className="leading-relaxed">
                      Мы ориентированы на максимальное удобство и комфорт для
                      наших заказчиков, поэтому вам не придется ехать в офис
                      нашей компании для заключения договора. Все необходимые
                      бумаги могут оформить специалисты, выезжающие для замера
                      на ваш объект.
                    </p>
                  </div>
                </div>
          ...
          <section className="py-16 md:py-24 px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-10">
                Call-центр работает ежедневно с 10:00 до 19:00. Мы готовы
